...
export const Contact = () => {
    ...
    useEffect(() => {
        ...
        if (
            socketError.func === 'addFriend' ||
            socketError.func === 'joinChannel'
        ) {
        ...
        <>
            <div className="wrapper">
                <div className="tabs">
                    <div
                        className={
                            chatContext.tabDisplay === 'friends'
                                ? 'active-tab'
                                : 'inactive-tab'
                        }
                        onClick={ChangeTabToFriends}>
                        <h4>Friends</h4>
                    </div>
                    <div
                        className={
                            chatContext.tabDisplay === 'channel'
                                ? 'active-tab'
                                : 'inactive-tab'
                        }
                        onClick={ChangeTabToChannel}>
                        <h4>Channel</h4>
                    </div>
                </div>
                {chatContext.tabDisplay === 'friends' ? (
